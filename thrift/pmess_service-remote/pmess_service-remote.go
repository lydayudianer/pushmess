...
func Usage() {
  ...
  fmt.Fprintln(os.Stderr, "  void Push( oids, i32 ptype, Tip tip)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := thrift.NewPmessServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "Push":
    ...
    containerStruct0 := thrift.NewPmessServicePushArgs()
    err10 := containerStruct0.ReadField1(jsProt9)
    if err10 != nil {
      Usage()
      return
    }
    argvalue0 := containerStruct0.Oids
    value0 := argvalue0
    ...
    argvalue2 := thrift.NewTip()
    err17 := argvalue2.Read(jsProt16)
    if err17 != nil {
      Usage()
      return
    }
